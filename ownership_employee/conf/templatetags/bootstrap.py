...
@register.filter
def bootstrap_horizontal(element, label_cols='col-2'):
...
def add_input_classes(field):
    ...
    if not is_checkbox(field) and not is_multiple_checkbox(field) \
       and not is_radio(field) and not is_file(field) :
        ...
        field.field.widget.attrs['placeholder'] = str(field.field.label)
...
def render(element, markup_classes):
    ...
    if element_type == 'boundfield':
        ...
        template = "form/bootstrapform/field.html"
        ...
        if has_management:
            ...
            template = "form/bootstrapform/formset.html"
            ...
            template = "form/bootstrapform/form.html"
