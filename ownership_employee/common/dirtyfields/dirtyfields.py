# code from https://github.com/romgar/django-dirtyfields
...
from common.dirtyfields.compare import raw_compare, compare_states, normalise_value
...
class DirtyFieldsMixin(object):
    ...
    def _as_dict(self, check_relationship, include_primary_key=True):
        ...
        for field in self._meta.fields:
            ...
            if field.remote_field:
                try:
                    field_value = (field.remote_field.model.objects.get(pk=getattr(self, field.attname)))
                    all_field[field.verbose_name] = deepcopy(str(field_value))
                    continue
            ...
            #all_field[field.verbose_name] = deepcopy(field_value)
            all_field[field.verbose_name] = deepcopy(field_value)
        return all_field
    ...
    def get_dirty_fields(self, check_relationship=True, check_m2m=None, verbose=False):
    ...
    if update_fields:
        for field_name in update_fields:
            ...
            if not FIELDS_TO_CHECK or \
                ...
                instance._original_state[field.verbose_name] = new_state[field.verbose_name]
